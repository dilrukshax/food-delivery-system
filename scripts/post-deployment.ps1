...
try {
    ...
    Write-Host "✗ Failed to update kubeconfig. Please try: aws eks update-kubeconfig --region us-west-2 --name food-delivery-cluster" -ForegroundColor Red
    exit 1
}
...
# Download IAM policy
$policyUrl = "https://raw.githubusercontent.com/kubernetes-sigs/aws-load-balancer-controller/v2.5.4/docs/install/iam_policy.json"
...
$controllerUrl = "https://github.com/kubernetes-sigs/aws-load-balancer-controller/releases/download/v2.5.4/v2_5_4_full.yaml"
Invoke-WebRequest -Uri $controllerUrl -OutFile "v2_5_4_full.yaml"
